...
echo ""
echo "   - Using Gemini CLI? Install the Gemini CLI commands with:"
echo "     curl -sSL https://raw.githubusercontent.com/buildermethods/agent-os/main/setup-gemini-code.sh | bash"
echo ""
